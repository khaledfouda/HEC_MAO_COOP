...
knitr::opts_chunk$set(echo = T, include=TRUE, cache = TRUE, collapse=TRUE, results = "hold")
library(kableExtra)
library(magrittr)
library(tidyverse)
...
print(paste("Execution time is",round(as.numeric(difftime(Sys.time(), start_time,units = "secs"))), "seconds"))
print(paste("Test error =", round(test_error(sout$A_hat[gen.dat$W==0], gen.dat$A[gen.dat$W==0]),5)))
cat(sprintf("Optimal hyperparameters are: lambda2 = %.4f, r=%d", sout$lambda, sout$rank.max))
```
...
cat(sprintf("Optimal hyperparameters are: lambda1 = %.4f, lambda2 = %.4f, r=%d", sout$lambda1, sout$best_fit$lambda, sout$best_fit$rank.max))
...
print(paste("Execution time is",round(as.numeric(difftime(Sys.time(), start_time,units = "secs"))), "seconds"))
print(paste("Test error =", round(test_error(sout$A_hat[gen.dat$W==0], gen.dat$A[gen.dat$W==0]),5)))
cat(sprintf("Optimal hyperparameters are: lambda1 = %.4f, lambda2 = %.4f, r=%d", sout$lambda1, sout$lambda2, sout$J))
